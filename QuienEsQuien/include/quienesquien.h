...
public:
	...
	*/
	...
	/**
	* @brief Método que selecciona los personajes que cumplen con los atributos pedidos.
	...
	* @return Devuelve el número de la pregunta más apropiada para hacer.
	*/
	int MejorPregunta(set<int> personajes_restantes, set<int> preguntas_restantes);


	/**
	* @brief Crea el árbol en base a los métodos cumplenPregunta y MejorPregunta.
	* @param personajes_restantes Personajes que quedan por descartar.
	* @param preguntas_restantes Preguntas que quedan por hacer.
	* @param n Nodo donde insertar el próximo personaje.
	...
	*/
	...
	/**
	* @brief Utilizado para saber las características que sabemos del personaje.
	...
	*/
	...
	/**
	* @brief Añade un personaje a la lista.
	* @param nombre Nombre del personaje a añadir.
	* @param caracteristicas Características del personaje a añadir.
	*/
