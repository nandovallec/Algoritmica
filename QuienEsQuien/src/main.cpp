...
int main(int argc, char * argv[]){
	...
	cout << "Inserto un nuevo personaje: " << endl << endl;
	std::vector<bool> caract = {false, true, true, false, true , false, false};
	quienEsQuien.aniade_personaje("Paco", caract);
	quienEsQuien.escribir_arbol_completo();
	
	cout << "Elimino el personaje insertado: " << endl << endl;
	quienEsQuien.elimina_personaje("Paco");
	quienEsQuien.escribir_arbol_completo();
	if(jugar){
